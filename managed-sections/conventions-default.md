...
- **After a resume or context compaction, re-establish ground truth:** working directory, branch, `git status`; re-read any file before editing it. Trust fresh tool output over remembered narrative.
