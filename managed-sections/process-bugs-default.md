...
For ordering-dependent defects, prefer a deterministic simulation and use `testing-by-simulation` when available. If an automated regression is impractical, record the specific constraint and run the strongest repeatable substitute before closing; do not hand testing to the user.
